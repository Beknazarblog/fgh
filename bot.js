...
bot.onText(/\/start/, (msg) => {
  ...
  const welcomeMessage = "Assalomu aleykum, Beknazar AI botiga hush kelibsiz! Mendan istalgan narsani so'rang, men sizga javob beraman.";
...
bot.on('message', async (msg) => {
  ...
  // /start komandasini boshqa qayta ishlamaslik
  ...
  try {
    ...
    // Foydalanuvchining xabariga javob yuborish
